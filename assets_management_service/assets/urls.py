...
urlpatterns = [
    ...
    path('assets/get_all_assets/', AssetServices.as_view({'get': 'get_all_assets'}), name="get_all_assets"),
    path('assets/get_asset_by_request_id/', AssetServices.as_view({'get': 'get_asset_by_request_id'}), name="get_asset_by_request_id"),
    path('assets/filter_api/', AssetServices.as_view({'post': 'filter_api'}), name="filter_api"),
